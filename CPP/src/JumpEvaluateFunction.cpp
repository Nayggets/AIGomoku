...
int JumpEvaluateFunction::evaluateBoard(Board* board, idPlayer value)
{
...
int JumpEvaluateFunction::evaluateLine(long playerBits, long opponentBits,int* nbOpenThree,int* nbFour)
{
    if(playerBits == 0){
        return 0;
    }
